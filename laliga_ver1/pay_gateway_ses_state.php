...
$sqlGetPaymentSource = "SELECT * FROM payment_court_tracker WHERE user_idno='$sesIdno'";

$resultPaySrc = $conn->query($sqlGetPaymentSource);
$viewPaySrc = mysqli_fetch_array($resultPaySrc);

if ($resultPaySrc->num_rows > 0) {
  // output data of each row
} else {
  echo "0 results";
}

 $viewPaySrc['paybook_amount'];
...
<div class="iphone">
  ...
  <form action="https://httpbin.org/post" class="form" method="POST">
    ...
    <div>
      ...
      <table>
        ...
        <tfoot>
          <tr>
            <td>Total</td>
            <td align="right"><?php echo "PHP " . $viewPaySrc['paybook_amount']; ?></td>
          </tr>
        </tfoot>
      </table>
    </div>
    ...
    <div>
      <a href="<?php echo $viewPaySrc['paymentbook_source']; ?>">GCASH</a>
    </div>
  </form>
</div>
