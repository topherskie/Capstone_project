...
<html lang="en">
  ...
  <body>
    ...
    <div id="root"></div>
    <script>
      const userName = "<?php echo $sesFname . ' ' . $sesLname; ?>"; 
      const sessionMeetingIdno = "<?php echo $sesIdno; ?>";
      console.log(sessionMeetingIdno);
      ...
      script.addEventListener("load", function (event) {
        ...
        const meetingId = sessionMeetingIdno;
        const name = userName;
        ...
        const config = {
          ...
          joinScreen: {
            ...
            title: "Tournament", // Meeting title
          ...
          leftScreen: {
            ...
            actionButton: {
              ...
              label: "Baller Live Now", // action button label
              href: "home_ses_state.php", // action button href
            },
          },
        };
