...
<div class="dec-dsg animate__animated animate__backInUp">
    <div>
       <form method="GET" action="player_decline_submit_server.php">
        <label>Decline Reason:</label>
            ...
            <br>
            <input type="submit" name="btnDeclineInvite" value="Decline" class="btn btn-outline-dark">
       </form>
    </div>
</div>