...
<div class="dec-dsg animate__animated animate__backInUp">
    <div>
       <form method="GET" action="player_quit_submit_server.php">
        <label>brief explanation why your leaving:</label>
            ...
            <br>
            <input type="submit" name="btnQuit" value="Submit" class="btn btn-outline-danger">
       </form>
    </div>
</div>