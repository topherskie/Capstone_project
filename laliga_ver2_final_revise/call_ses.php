...
?>
 ...
 .main-call-container  {
    ...
    <br>
    <div class="main-call-container form-group animate__animated animate__backInUp">

      <div class="call-one-container effect1">
         <div><h5>Meet ID: </h5><h5 id="txtMeetID"></h5></div>
        <label>Join Meeting</label>
        <input type="text" id="txtMeetId" placeholder="enter meeting ID" required class="form-control">
        <div>
          <br>
...
const sesFname = "<?php echo $userFirstname; ?>";
const sesLname = "<?php echo $userLastname; ?>";
 ...
 var script = document.createElement("script");
      ...
      script.addEventListener("load", function (event) {
        ...
        const config = {
          ...
          containerId: null,
          redirectOnLeave: "http://localhost/laligaRd/call_ses.php",
