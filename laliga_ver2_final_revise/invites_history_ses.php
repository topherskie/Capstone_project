...
$inviteHis = "SELECT * FROM player_invites_dec WHERE player_id='$userIdno'";
...
<div class="his-dec animate__animated animate__bounceInUp">
...
<?php while($rowDataHis = $queryHis->fetch_assoc()): ?>
    <tr>
      <td><?php echo $rowDataHis['scout_name']; ?></td>
